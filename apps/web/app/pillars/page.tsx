  ...
  return (
    <div className={styles.container}>
      ...
      <div className={`${styles.description} ${styles.description3}`}>
        After her husband leaves her, young mother of two Miriam
        &quote;Midge&quote; Maisel discovers that she has a talent for stand-up
        comedy. Could this be her calling?
      </div>
